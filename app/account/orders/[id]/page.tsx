      ...
      <>
        ...
        <main className="min-h-screen pt-32 pb-16 px-4 bg-black">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link href="/account" className="text-gray-400 hover:text-[#4A90E2]">
              ← Back to Orders
            </Link>
          </div>
        </main>
    ...
    <>
      ...
      <main className="min-h-screen bg-black pt-32 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <Link
            href="/account"
            className="inline-flex items-center gap-2 text-gray-400 hover:text-[#4A90E2] mb-6"
          >
          ...
          <motion.div
            ...
            className="bg-[#2d2d2d] rounded-xl shadow-sm p-8 border border-white/10"
          >
            {/* Header */}
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                {order.items.map((item) => (
                  <div key={item.id} className="flex justify-between items-start border border-white/10 rounded-lg p-4">
                    <div className="flex-1">
                      <h3 className="font-medium text-white">{item.title}</h3>
                      {item.variantTitle && (
                        <p className="text-sm text-gray-300 mt-1">{item.variantTitle}</p>
                      )}
                      <p className="text-sm text-gray-300 mt-2">Quantity: {item.quantity}</p>
                    </div>
                    <div className="text-right">
            ...
            {order.shippingAddress && (
              <div className="mb-8">
                ...
                <div className="bg-[#1a1a1a] rounded-lg p-4 border border-white/10">
                  ...
                  <p className="text-gray-300 mt-2">{order.shippingAddress.address1}</p>
