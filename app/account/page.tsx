      ...
      <main className="min-h-screen bg-black pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300">Welcome back, {customer?.firstName}!</p>
          </motion.div>
              ...
              <div className="bg-[#2d2d2d] rounded-xl shadow-sm p-8 border border-white/10">
                ...
                {loading ? (
                  <div className="space-y-4">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="animate-pulse border border-white/10 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    {orders.map((order) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        className="border border-white/10 rounded-lg p-6 hover:border-[#4A90E2] transition-colors"
                      >
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-2 text-gray-400 hover:text-[#4A90E2] font-medium text-sm"
                        >
                          View Details
