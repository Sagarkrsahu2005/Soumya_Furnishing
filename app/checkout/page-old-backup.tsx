...
export default function CheckoutPage() {
  ...
  const [quickViewVariantId, setQuickViewVariantId] = useState<string | undefined>()
  const [isQuickViewOpen, setIsQuickViewOpen] = useState(false)

  const openQuickView = (product: Product, variantId?: string) => {
    console.log('openQuickView called:', {
    ...
    setQuickViewVariantId(variantId)
  ...
  const closeQuickView = () => {
    ...
    setTimeout(() => {
      ...
      setQuickViewVariantId(undefined)
    }, 300)
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-12">
            ...
            >
              <div className="sticky top-24 bg-[#0f0f0f] rounded-2xl border border-white/10 p-6 md:p-8">
                ...
                {/* Cart Items Table */}
                <div className="mb-6 pb-6 border-b border-white/10 overflow-hidden">
                    ...
                    <table className="w-full">
                      <thead>
                        <tr className="border-b border-white/5">
                          ...
                          <th className="text-center py-3 px-2 text-xs font-bold text-gray-400 uppercase tracking-wider">
                            Qty
                          </th>
                        ...
                        {items.map((item) => {
                          ...
                          return (
                            <tr 
                              ...
                              onClick={() => openQuickView(item.product, item.variantId)}
                              className={`hover:bg-white/5 transition-colors cursor-pointer group border-l-4 ${variant ? colors.border : 'border-l-gray-700'}`}
                            >
                              {/* Product Info */}
                              <td className="py-4 px-2">
                                <div className="flex gap-3 items-start">
                                  <div className={`relative w-16 h-16 flex-shrink-0 bg-[#1a1a1a] rounded-lg overflow-hidden border-2 ${variant ? colors.borderColor : 'border-white/10'} group-hover:shadow-lg transition-all`}>
                                    <Image
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    {variant && (
                                      <div className={`mb-2 px-3 py-1.5 ${colors.bg} rounded-lg border ${colors.borderColor} inline-block`}>
                                    ...
                                    <p className="text-xs text-gray-500">
                                      {formatPrice(item.product.price / 100)} each
                                    </p>
                                    <p className="text-xs text-emerald-400 opacity-0 group-hover:opacity-100 transition-opacity mt-1">
                              ...
                              <td className="py-4 px-2">
                                <div className="flex justify-center">
                                  <div className={`w-10 h-10 rounded-lg bg-gradient-to-br ${colors.bg} border-2 ${colors.borderColor} flex items-center justify-center shadow-sm`}>
                                    <span className={`text-sm font-bold ${colors.text}`}>{item.quantity}</span>
                                  </div>
                                </div>
                              </td>
