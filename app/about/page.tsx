...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      {/* Hero Section */}
      <section className="relative h-96 md:h-[500px] w-full overflow-hidden bg-[#1a1a1a]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Elevating Artisan Craft</h2>
        ...
        >
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4 text-balance">Our Values</h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">Guiding every decision we make</p>
          </div>
            ...
            {values.map((value, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                    className="bg-[#1a1a1a] p-8 md:p-10 rounded-lg border-t-4 border-[#4A90E2] shadow-lg hover:shadow-2xl transition-shadow"
                  >
                    <div className="w-16 h-16 rounded-full bg-[#4A90E2]/20 flex items-center justify-center mb-6">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="bg-[#1a1a1a] p-8 md:p-16 rounded-lg mb-20 md:mb-32 border border-white/10"
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">Sustainable from the Ground Up</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-semibold text-white mb-3">Eco-Friendly Materials</h3>
              <p className="text-gray-300 leading-relaxed mb-6">
                We source organic cotton, linen, wool, and natural dyes. All packaging is biodegradable or recycled.
              </p>
              <h3 className="font-semibold text-white mb-3">Carbon-Neutral Shipping</h3>
              <p className="text-gray-300 leading-relaxed">
                Every order is shipped with carbon offset, ensuring minimal environmental impact.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-white mb-3">Ethical Production</h3>
              <p className="text-gray-300 leading-relaxed mb-6">
                We follow fair trade principles with transparent supply chains and regular audits.
              </p>
              <h3 className="font-semibold text-white mb-3">Community Impact</h3>
              <p className="text-gray-300 leading-relaxed">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 md:mb-16">In the Media</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
            {media.map((outlet) => (
              <motion.div
                key={outlet.name}
                whileHover={{ scale: 1.05 }}
                className="p-6 bg-[#1a1a1a] rounded border border-white/10 hover:border-[#4A90E2]/50 transition-colors cursor-pointer"
              >
                <p className="font-semibold text-white text-sm md:text-base">{outlet.logo}</p>
              </motion.div>
            ))}
          </div>
