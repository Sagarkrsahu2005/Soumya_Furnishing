...
export default function WhySoumya() {
  ...
  return (
    <section ref={ref} className="py-20 md:py-32 px-4 md:px-8 bg-gradient-to-br from-black via-[#0a0a0a] to-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <span className="text-sm font-light tracking-widest text-[#4A90E2] uppercase">Why Choose Us</span>
          <h2 className="text-4xl md:text-5xl font-playfair text-white mt-3 leading-tight">
            The Soumya Promise
          </h2>
        </motion.div>
            ...
            return (
              ...
              >
                <div 
                  ...
                  className="rounded-2xl p-8 h-full flex flex-col relative overflow-hidden hover:shadow-xl transition-all duration-300 bg-[#1a1a1a]/70 backdrop-blur-sm border border-white/10"
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-lg md:text-xl font-playfair text-white mb-3">
                      {feature.title}
                    </h3>
